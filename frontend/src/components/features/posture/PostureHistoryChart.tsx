        ...
        <div className="sf-card p-4">
            <div className="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p className="text-[10px] text-sf-muted mt-0.5">Are we getting better?</p>
                </div>
                {mounted && data.length > 1 && (
                    <div className="text-right">
                        <div className="text-lg font-condensed font-bold text-sf-text">
                            {Math.round(data[data.length - 1]?.score ?? 0)}
                        </div>
                        <div className="text-[9px] text-sf-muted font-space">current</div>
                    </div>
                )}
            </div>
            {mounted ? (
                ...
                <div style={{ height: 200 }} className="flex items-center justify-center text-sf-muted text-xs font-space">
                    Loading chart...
                </div>
            )}
        </div>
