...
export function PostureChart() {
 ...
 <stop offset="5%" stopColor="var(--ng-magenta)" stopOpacity={0.3} />
 <stop offset="95%" stopColor="var(--ng-magenta)" stopOpacity={0} />
 </linearGradient>
 </defs>
 <XAxis
 dataKey="time"
 ...
 />
 <Tooltip
 contentStyle={{ backgroundColor: 'var(--ng-base)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '8px' }}
 itemStyle={{ color: 'var(--ng-base)' }}
