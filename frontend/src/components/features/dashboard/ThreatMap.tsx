...
export function ThreatMap() {
 ...
 return (
 <div className="absolute inset-0 overflow-hidden bg-ng-base flex items-center justify-center">
 ...
 <motion.div
 className="w-2.5 h-2.5 bg-ng-magenta rounded-full shadow-[0_0_15px_rgba(249,115,22,1)]"
 animate={{ opacity: [1, 0.4, 1] }}
 transition={{ duration: 2 + Math.random(), repeat: Infinity, ease: "easeInOut" }}
 />
 <motion.div
 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 rounded-full border border-ng-magenta/40"
