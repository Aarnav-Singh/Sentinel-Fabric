...
export function ShimmerSkeleton({ className = "" }: { className?: string; }) {
  return (
    <div className={`relative overflow-hidden bg-sf-surface border border-sf-border rounded-[2px] ${className}`}>
      <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-sf-accent/10 to-transparent animate-sf-shimmer" />
    </div>
  );
}
