...
export function StreamBar({ abbr, description, score, color = "var(--ng-cyan-bright)" }: StreamBarProps) {
 ...
 <span className="text-[11px] text-ng-muted">{description}</span>
 </div>
 <span className="text-xs font-mono" style={{ color }}>
 {Math.round(animated * 100)}%
 </span>
 </div>
 <div className="h-1 bg-ng-mid-raised rounded-none overflow-hidden">
 <div
