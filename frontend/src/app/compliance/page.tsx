      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm">SOC 2 Type II audit trail + MITRE ATT&CK coverage</p>
          </div>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {tscStatuses.map(tsc => (
              <div key={tsc.tsc} className="bg-brand-card/70 border border-brand-accent/10 p-4 rounded-xl">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-brand-accent font-mono text-xs font-bold">{tsc.tsc}</span>
