...
export default function IncidentDetailPage({ params }: { params: { id: string } | Promise<{ id: string }> }) {
    ...
    if (isLoading) {
        return (
            <div className="flex-1 flex flex-col items-center justify-center min-h-[500px] h-full bg-transparent">
                <div className="w-8 h-8 border-2 border-[var(--sf-accent)] border-b-transparent rounded-full animate-spin mb-4"></div>
                <p className="text-sf-muted text-sm font-mono uppercase tracking-widest font-bold animate-pulse">Establishing Connection...</p>
            </div>
        );
    }
    ...
    const severityColor = isCritical 
        ? "text-[var(--sf-critical)] bg-[var(--sf-critical)]/10 border-[var(--sf-critical)]/30" 
        : isHigh
    ...
    return (
        <div className="flex-1 flex flex-col h-full overflow-y-auto custom-scrollbar bg-transparent">
            {/* Content Header */}
            <header className="sticky top-0 z-10 p-6 flex items-center justify-between border-b border-sf-border/50 bg-sf-surface/80 backdrop-blur-xl">
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex gap-2">
                            <span className={`px-2 py-0.5 rounded text-[10px] uppercase font-bold tracking-widest border ${finding.status === 'open' ? 'bg-[var(--sf-warning)]/10 text-[var(--sf-warning)] border-[var(--sf-warning)]/30' : 'bg-[var(--sf-safe)]/10 text-[var(--sf-safe)] border-[var(--sf-safe)]/30'}`}>
                                {finding.status}
                            </span>
            ...
            <div className="p-6 grid grid-cols-12 gap-6 max-w-screen-2xl mx-auto w-full">
                    ...
                    <div className="sf-card p-5">
                        ...
                        <div className="p-3 bg-sf-bg/50 rounded-lg border border-sf-border/50 space-y-3 shadow-inner">
                            ...
                            <div className="flex justify-between items-center text-[11px]">
                                ...
                                <span className="text-[var(--sf-accent)] font-mono">{finding.finding_id.substring(0,8)}</span>
                            </div>
                        </div>
                    </div>
                                ...
                                <div key={idx} className="flex items-center justify-between p-3 bg-sf-bg rounded-lg border border-sf-border/50 hover:border-slate-600 transition-colors">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="overflow-hidden">
                                            <p className="text-[10px] text-sf-muted uppercase tracking-widest font-bold mb-0.5">{entity.type}</p>
                ...
                <div className="col-span-12 xl:col-span-6 space-y-6">
                    ...
                    <div className="sf-card overflow-hidden flex flex-col h-[300px]">
                        ...
                        <div className="flex-1 overflow-x-auto custom-scrollbar">
                            <table className="w-full text-left text-xs whitespace-nowrap">
                                <thead className="bg-sf-bg/50 text-sf-muted text-[10px] uppercase tracking-widest">
                                    <tr>
                    ...
                    <div className="sf-card p-6">
                        ...
                        <div className="relative pl-6 space-y-8 before:content-[''] before:absolute before:left-2 before:top-2 before:bottom-2 before:w-[2px] before:bg-sf-surface">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1 bg-sf-bg/50 border border-sf-border/50 rounded-lg p-3">
                                    ...
                                    <span className="text-[10px] text-sf-muted font-mono mt-2 block">{new Date(finding.created_at).toLocaleString()}</span>
                                </div>
                            </div>
                ...
                <div className="col-span-12 xl:col-span-3 space-y-6">
                    ...
                    <div className="sf-card p-5 relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-2 mb-6 focus-border">
                            <CheckCircle2 className="w-5 h-5 text-[var(--sf-accent)]" />
